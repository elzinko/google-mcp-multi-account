...
- Retirer / rendre optionnel le symlink `/opt/homebrew` (dépend de 0018).
...
Dépend de [[0018]] (chemins portables) pour un `.mcpb` non-macOS. Coordonner avec
la fiche 0013 (déjà livrée) pour ne pas dupliquer le branchement. Voir épic [[0017]].
