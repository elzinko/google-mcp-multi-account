...
| # | Titre | Type | Prio | Épic | Statut | PR |
|---|-------|------|------|------|--------|----|
| 0014 | Généraliser le projet à d'autres utilisateurs que l'auteur | epic | P2 |  | 💡 idea |  |
...
| 0015 | Cross-platform — faire tourner le projet hors macOS (Linux, Intel) | feature | P2 | 0014 | 💡 idea |  |
| 0016 | Documentation anglaise — ouvrir le projet à une audience non francophone | feature | P2 | 0014 | 💡 idea |  |
| 0017 | Packaging installable — sortir du git clone + symlink codé en dur | feature | P2 | 0014 | 💡 idea |  |
...
| 0018 | Élargir la couverture MCP — Calendar, Docs, Sheets, Tasks (et écritures) | feature | P3 | 0014 | 💡 idea |  |

> Livrées (`done/`) : 0002, 0004, 0005, 0007, 0008, 0009, 0010, 0011, 0012, 0013.
