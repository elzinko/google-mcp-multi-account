...
from .project import manifest_drive_zones, resolve_project
...
def handle_exec(
    ...
    *,
    ...
    if use_session:
        ...
        proj = resolve_project(Path(git_root) if git_root else None)
        if proj.manifest_valid and proj.manifest:
            session_zones |= manifest_drive_zones(proj.manifest, alias)
